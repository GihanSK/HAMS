<template>
  <div>
    ...
    <section class="section is-main-section">
      <card-component class="has-table has-mobile-sort-spaced" title="Doctor's Profiles Approved List" icon="account-multiple">
        <card-toolbar>
          ...
          :data="pendingList">
            ...
            <b-table-column custom-key="actions" class="is-actions-cell" v-slot="props">
              <div class="buttons is-right">
                <router-link :to="{name:'approved.view', params: {id: props.row.id}}" class="button is-small is-primary">
