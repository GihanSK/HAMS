(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_admin_DoctorTypes_list_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/admin/DoctorTypes/list.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/admin/DoctorTypes/list.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    validateAndUpdate: function validateAndUpdate() {
      if (this.formData.name == "") {
        this.invalidFileds.name = "Name is required";
      } else {
        this.updateData();
    ...
    updateData: function updateData() {
      var _this = this;
      axios.post('/admin/doctorTypeUpdate', {
    ...
    showData: function showData() {
      var _this2 = this;
      axios.post('/admin/showDoctorType', {
        id: this.formData.id
      }).then(function (r) {
        console.log(r.data);
        _this2.formData.name = r.data.name;
      })["catch"](function (err) {
    ...
    submitData: function submitData() {
      var _this3 = this;
      axios.post('/admin/doctorTypeStore', {
        name: this.formData.name
      }).then(function (r) {
        console.log(r.data);
    ...
    getData: function getData() {
      var _this4 = this;
      this.isLoading = true;
      axios.get('/admin/doctorTypes').then(function (r) {
        console.log(r.data);
        _this4.isLoading = false;
        if (r.data) {
          if (r.data.length > _this4.perPage) {
            _this4.paginated = true;
          }
          _this4.pendingList = r.data;
        }
      })["catch"](function (err) {
        _this4.isLoading = false;
    ...
    trashConfirm: function trashConfirm() {
      ...
      if (this.trashObject) {
        method = 'delete';
        url = "admin/".concat(this.trashObject.id, "/destroy");
...
/***/ "./resources/js/views/admin/DoctorTypes/list.vue":
/*!*******************************************************!*\
  !*** ./resources/js/views/admin/DoctorTypes/list.vue ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _list_vue_vue_type_template_id_cb8ecfdc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=cb8ecfdc& */ "./resources/js/views/admin/DoctorTypes/list.vue?vue&type=template&id=cb8ecfdc&");
/* harmony import */ var _list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list.vue?vue&type=script&lang=js& */ "./resources/js/views/admin/DoctorTypes/list.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _list_vue_vue_type_template_id_cb8ecfdc___WEBPACK_IMPORTED_MODULE_0__.render,
  _list_vue_vue_type_template_id_cb8ecfdc___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/admin/DoctorTypes/list.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/admin/DoctorTypes/list.vue?vue&type=script&lang=js&":
/*!********************************************************************************!*\
  !*** ./resources/js/views/admin/DoctorTypes/list.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./list.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/admin/DoctorTypes/list.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/admin/DoctorTypes/list.vue?vue&type=template&id=cb8ecfdc&":
/*!**************************************************************************************!*\
  !*** ./resources/js/views/admin/DoctorTypes/list.vue?vue&type=template&id=cb8ecfdc& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_list_vue_vue_type_template_id_cb8ecfdc___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_list_vue_vue_type_template_id_cb8ecfdc___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_list_vue_vue_type_template_id_cb8ecfdc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./list.vue?vue&type=template&id=cb8ecfdc& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/admin/DoctorTypes/list.vue?vue&type=template&id=cb8ecfdc&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/admin/DoctorTypes/list.vue?vue&type=template&id=cb8ecfdc&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/admin/DoctorTypes/list.vue?vue&type=template&id=cb8ecfdc& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      _c(
        ...
        [
          ...
          _c(
            "b-button",
            {
              attrs: { slot: "right", type: "is-success" },
              on: {
        ...
        [
          _c(
            "card-component",
            {
              ...
              attrs: { title: "Doctor Types", icon: "account-multiple" },
            },
            [
              _c("card-toolbar", [
                _c(
                            ...
                            _c("div", { staticClass: "buttons is-right" }, [
                              _c(
                                "button",
                                {
                                  ...
                                  on: {
                                    click: function ($event) {
                                      return _vm.openEditModal(props.row.id)
                                    },
                                  },
                                },
                                [
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      attrs: {
                        type: _vm.invalidFileds.name == "" ? "" : "is-danger",
                        message: _vm.invalidFileds.name,
                      },
                    },
                    [
                      _c("b-input", {
                        attrs: { placeholder: "Doctor Type" },
                        model: {
